        ...
        new AnimatedContainer(duration: const Duration(milliseconds: 5),
          child:SizedBox(
              child: new Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: <Widget>[
                  Text('Going with admin login first go to "settings" then click "employee" to register employee. ',style: TextStyle(fontWeight: FontWeight.bold),),
                  SizedBox(height: MediaQuery.of(context).size.height * 0.005,),
                  Text("    1. Enter first name & last name"),
                  SizedBox(height: MediaQuery.of(context).size.height * 0.005,),
                  Text("    2. Enter employee email(optional)"),
                  SizedBox(height: MediaQuery.of(context).size.height * 0.005,),
