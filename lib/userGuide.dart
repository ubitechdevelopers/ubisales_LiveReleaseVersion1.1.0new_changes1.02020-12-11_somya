  ...
  userWidget(){
    ...
    return Container(
      ...
      child:ListView(
        ...
        new AnimatedContainer(duration: const Duration(milliseconds: 5),
          child:SizedBox(
              child: new Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: <Widget>[
                  Text("1. Click on “Log” on home screen to check your last 7 days attendance which includes:",style: TextStyle(fontWeight: FontWeight.bold),),
                  SizedBox(height: MediaQuery.of(context).size.height * 0.005,),
                  Text("     >Date"),
                  SizedBox(height: MediaQuery.of(context).size.height * 0.005,),
        ...
        GestureDetector(
          onTap: ()=>setState((){
            _animatedHeight_attreport==0.0?_animatedHeight_attreport=MediaQuery.of(context).size.height * 0.35:_animatedHeight_attreport=0.0;}),
        ...
        GestureDetector(
          onTap: ()=>setState((){
            _animatedHeight_configure==0.0?_animatedHeight_configure=MediaQuery.of(context).size.height * 0.37:_animatedHeight_configure=0.0;}),
