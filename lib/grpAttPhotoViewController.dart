...
class GrpAttControllerExample extends StatefulWidget {
  final File image;
  const GrpAttControllerExample({Key key, this.image}) : super(key: key);
  @override
  _GrpAttControllerExampleState createState() => _GrpAttControllerExampleState(image);
}
...
const double defScale = 1.5;
const double maxScale = 2.6;

class _GrpAttControllerExampleState extends State<GrpAttControllerExample> {

  final File image;


  bool captureClicked=false;
  _GrpAttControllerExampleState(this.image) ;
  ...
  void initState() {
    ...
    super.initState();
    Future.delayed(Duration(seconds: 2), () => _capturePng());
