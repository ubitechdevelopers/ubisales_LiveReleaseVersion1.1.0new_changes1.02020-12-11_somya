class Employee {
  ...
  Employee(this.response,this.fname,this.lname,this.empid,this.email,this.status,this.orgid,this.orgdir,this.sstatus,this.org_name,this.desination,this.profile,this.org_perm,this.desinationId,this.imgstatus);
