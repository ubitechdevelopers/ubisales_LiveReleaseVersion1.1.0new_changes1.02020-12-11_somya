...
class EmpPinComponent extends StatefulWidget {

  double pinPillPosition;
  PinInformation currentlySelectedPin;

  EmpPinComponent({ this.pinPillPosition, this.currentlySelectedPin});

  @override
  State<StatefulWidget> createState() => EmpPinComponentState();
}

class EmpPinComponentState extends State<EmpPinComponent> {
