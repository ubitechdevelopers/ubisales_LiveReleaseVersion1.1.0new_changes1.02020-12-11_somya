...
public class LocationListenerExecuterOld extends AsyncTask<String, String, String> {
private MethodChannel channel;
private MainActivity activity;
    private LocationAssistant assistant;
public LocationListenerExecuterOld(MethodChannel channel, MainActivity activity){
